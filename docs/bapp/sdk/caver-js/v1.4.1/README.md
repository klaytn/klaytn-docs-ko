...
Klaytn은 고정된 가스 가격 \(25 ston = 25 \* 10^9\)을 사용합니다. Klaytn 네트워크에 제출된 다른 가스 가격의 트랜잭션은 거절됩니다. 가스 가격에 대한 자세한 내용은 [Gas and Unit Price Overview](../../../../klaytn/design/transaction-fees.md#gas-and-unit-price-overview)를 참조하세요. 네트워크에서 사용되는 가스 가격은 [caver.klay.getGasPrice](api-references/caver.klay/config.md#getgasprice)를 사용하여 얻을 수 있습니다.
